...
public class Exercicio45_02 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner input = new Scanner(System.in);
		ArrayList <Character> gabarito = new ArrayList<>();
		char resposta, novoCalculo, respostaGabarito;
		int nota = 0, maior, menor, soma = 0, notaAtual, r=1;
		float media = 0;
		ArrayList <Integer> notas = new ArrayList<>();
		
		System.out.println("Vamos cadastrar o gabarito do professor\nPara finalizar digite 0\n");
		do {
			do {
				System.out.print("Informe a " + r + "ª resposta: ");
				respostaGabarito = Character.toUpperCase(input.next().charAt(0));
			} while (respostaGabarito != 'A' && respostaGabarito != 'B' && respostaGabarito != 'C' && respostaGabarito != 'D' && respostaGabarito != 'E' && respostaGabarito != '0');
			
			if (respostaGabarito != '0') {
				gabarito.add(respostaGabarito);
				r++;
			}
			
		} while (respostaGabarito != '0');
