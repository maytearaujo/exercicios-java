...
public class HeartRatesTest {
	...
	public static void main(String[] args) {
		...
		int mesNascimento, diaNascimento, anoNascimento;
		...
		//HeartRates heartRates = new HeartRates("Marilia", "Gabriela", 4, 9, 1980);
		HeartRates heartRates = new HeartRates(nome, sobrenome, mesNascimento, diaNascimento, anoNascimento);
